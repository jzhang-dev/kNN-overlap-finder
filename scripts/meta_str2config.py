from meta_nearest_neighbors import NearestNeighborsConfig
from dim_reduction import SpectralEmbedding, scBiMapEmbedding,GaussianRandomProjection,SparseRandomProjection,SimHash_Dimredu,PCA,isomap,umap
from meta_nearest_neighbors import ExactNearestNeighbors,HNSW,LowHash,SimHash

max_bucket_size=20
def parse_string_to_config(input_string: str) -> NearestNeighborsConfig:
    # 将字符串按下划线分割
    mydict = {  
    ...
    if len(parts) == 5:
        ...
        raise ValueError(f"{input_string} don't fit.")
