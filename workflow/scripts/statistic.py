...
# 输入文件夹路径  
# folder_path = ['CHM13/IGK/real_cyclone','CHM13/HLA/real_cyclone','CHM13/chr1_248M/real_cyclone','CHM13/chr22_51M/real_cyclone',
...
folder_path = ['CHM13/chr22_51M/real_cyclone']
# 输出文件名  
output_file1 = "summarize_stat_chr22_cyclone.tsv"
