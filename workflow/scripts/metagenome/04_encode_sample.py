...
# Build matrix
feature_matrix, read_features = finding_kmer(kmer_dict, read_sequences, 11)

output_ref_npz_file = '/home/miaocj/docker_dir/kNN-overlap-finder/data/feature_matrix/metagenome/GTDB/kmer_k11/sample1_feature_matrix.npz'
output_json_file = '/home/miaocj/docker_dir/kNN-overlap-finder/data/feature_matrix/metagenome/GTDB/kmer_k11/sample1_read_features.json.gz'
